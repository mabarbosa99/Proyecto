<table id="id_de_la_tabla" >
    ...
    <tbody>
        <?php
            ...
            $sentencia="SELECT Id_Cliente, Nombre, Barrio, Telefono1, Telefono2, Direccion FROM cliente";
        ...
        ?>
                <tr>
                    ...
                    <td><a href="funciones/Actualizar_cliente.php?Id_Cliente=<?php echo $filas[0]?>"><button class="btn btn-primary glyphicon glyphicon-pencil"></button></a></td>
