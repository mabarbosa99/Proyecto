                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="container">
                                    ...
                                    <br>
                                        <form action="funciones/registrar_cliente.php"  method="post" class="formulario" id="formulario">
                                            ...
                                            <div class="formulario__grupo" id="grupo__telefono">
                                             ...
                                             <div class="formulario__grupo" id="grupo__telefonos">
                                                ...
                                                <div class="formulario__grupo-input">
                                                    <input type="text" class="formulario__input" name="telefonos" id="telefonos" >
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                                <p class="formulario__input-error">El telefono solo puede contener numeros y el maximo son 10 dígitos</p>
                                            </div>
                                            ...
                                            <input type="submit" onclick="registrarCliente()" name="enviar" id="enviar" value="Registrar" class="au-btn au-btn--block au-btn--green m-b-20">
