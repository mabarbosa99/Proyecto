                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="email" name="email" placeholder="Contraseña">
                                    <label>Confirme la contraseña</label>
                                    <input class="au-input au-input--full" type="email" name="email" placeholder="Confirmar contraseña">
                                </div>
