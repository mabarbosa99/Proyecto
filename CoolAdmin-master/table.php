...
if(isset($_POST["importar"])){
    ...
    for($i = 2; $i <= $num_filas; $i++){
        ...
        //--- IDENTIFICACION 
        $identificacion = $objPHPExcel->getActiveSheet()->getCell('A'.$i)->getCalculatedValue();
        ...
        //--- EMAIL
        $email = $objPHPExcel->getActiveSheet()->getCell('F'.$i)->getCalculatedValue();

        //--- IMPRIMIR EN HTML 

        // --- SECCION 4 ---
        $sql = "INSERT INTO `supervisor`(`Identificacion`, `Nombre`, `Apellido`, `Telefono`, `Direccion`, `Correo_electronico`) VALUES ('$identificacion','$nombre','$apellido','$telefono', '$direccion', '$email')"; 
         
        $resultado = mysqli_query($conexion, $sql);

        if($resultado){

            echo "<script>alert('Se insertaron correctamente'); window.location.href='supervisor.php'</script>";
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="overview-wrap">
                                        ...
                                        <form name="frm" method="post" action="" enctype="multipart/form-data" accept-charset="UTF-8" id="LayoutGrid1">
                                                ...
                                                <a href="ExportarTablaS.php"><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                                    <i class="glyphicon glyphicon-download"></i>Exportar</button></a>
                                                    <a href="nuevoSupervisor.php"><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                                    <i class="zmdi zmdi-plus"></i>Supervisor</button></a>
                                        </div>
                                </div>
