<table id="id_de_la_tabla" >
    ...
    <tbody>
        <?php
            ...
            $sentencia="SELECT id_domiciliario, Identificacion, Nombre, Apellido, Telefono, Direccion, Correo_electronico FROM domiciliario";
        ...
        ?>
                <tr>
                    ...
                    <td><button class="btn btn-danger glyphicon glyphicon-remove" onclick="preguntarSiNoD(`<?php echo $datos ?>`)"></button></td>
                </tr>
