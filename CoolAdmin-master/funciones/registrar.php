...
<?php
  ...
  $sql = "INSERT INTO `supervisor`(`Identificacion`, `Nombre`, `Apellido`, `Telefono`, `Direccion`, `Correo_electronico`) 
  VALUES ('".$_POST['identificacion']."','".$_POST['nombre']."', '".$_POST['apellido']."',
  '".$_POST['telefono']."', '".$_POST['direccion']."', '".$_POST['correo']."')";

  $resultado=mysqli_query($conexion, $sql) or die (mysqli_error($conexion));
  $cadena = substr(str_shuffle("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 10);
  $Contraseña = sha1($cadena);
  $sql = "INSERT INTO `usuarios`(`usuario`, `contraseña`, `FK_roles_id`, `FK_id_supervisor`) VALUES ('".$_POST['nombre']."','$Contraseña', 2, 2)";
