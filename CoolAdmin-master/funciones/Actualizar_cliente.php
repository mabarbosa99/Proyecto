<?php
      ...
      $consulta=ConsultarProducto($_GET['Id_Cliente']);

      function ConsultarProducto($id)
      {
          include '../conexion/conexion.php';
          $sentencia="SELECT Id_Cliente, Nombre, Barrio, Telefono1, Telefono2, Direccion FROM cliente WHERE Id_Cliente='".$id."' ";
...
<head>
    ...
    <!-- Title Page-->
    <title>Actualizar Domiciliario</title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="login-content">
                                    ...
                                    ?>
                                    <form action="Actualizar_cliente_2.php"  method="post" class="formulario" id="formulario">
                                            
                                             <!-- Grupo: Identificacion -->
                                             <div class="formulario__grupo" id="grupo__identificacion">
                                                <label for="identificacion" class="formulario__label">Identificación Cliente</label>
                                            ...
                                            <div class="formulario__grupo" id="grupo__barrio">
                                                ...
                                                <div class="formulario__grupo-input">
                                                    <input type="text" class="formulario__input" name="barrio" id="barrio"  value="<?php echo $consulta[2];?>" >
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                            ...
                                            <div class="formulario__grupo" id="grupo__telefono">
                                                <label for="telefono" class="formulario__label">Teléfono 1</label>
                                                <div class="formulario__grupo-input">
                                             ...
                                             <div class="formulario__grupo" id="grupo__telefonos">
                                                <label for="telefonos" class="formulario__label">Teléfono 2</label>
                                                <div class="formulario__grupo-input">
                                                    <input type="text" class="formulario__input" name="telefonos" id="telefonos" value="<?php echo $consulta[4];?>" >
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                                <p class="formulario__input-error">El telefono solo puede contener numeros y el maximo son 10 dígitos</p>
                                            </div>
                                            ...
                                            <div class="formulario__grupo" id="grupo__direccion">
                                                ...
                                                <div class="formulario__grupo-input">
                                                    <input type="text" class="formulario__input" name="direccion" id="direccion"  value="<?php echo $consulta[5];?>" >
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                            ...
                                            <input type="submit" onclick="editarCliente()" name="enviar" id="enviar" value="Actualizar" class="au-btn au-btn--block au-btn--green m-b-20">
                                            </div>
                                            <!--<div class="formulario__grupo" id="grupo__identificacion">
                                                <div class="formulario__grupo-input">
                                                    <input type="hidden" class="formulario__input" name="Id_Cliente" id="Id_Cliente" value="<?php echo $_GET['Id_Cliente']?>">
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                                <p class="formulario__input-error">La identificación solo puede contener numeros y un maximo de 10 dígitos</p>
                                            </div>-->
