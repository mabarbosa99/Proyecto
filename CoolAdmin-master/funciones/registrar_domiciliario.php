...
<?php
  ...
  $sql = "INSERT INTO `domiciliario`(`Identificacion`, `Nombre`, `Apellido`, `Telefono`, `Direccion`, `Correo_electronico`) 
  ...
  $sql = "INSERT INTO `usuarios`(`usuario`, `contraseña`, `FK_roles_id`, `FK_id_supervisor`) VALUES ('".$_POST['nombre']."','$Contraseña', 4, 4)";
