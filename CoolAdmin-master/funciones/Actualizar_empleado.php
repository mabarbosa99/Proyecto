...
$consulta=ConsultarProducto($_GET['id_empleado']);

        function ConsultarProducto($id)
        {
            include '../conexion/conexion.php';
            $sentencia="SELECT Identificacion, Nombre, Apellido, Telefono, Direccion, Correo_electronico FROM empleado WHERE id_empleado='".$id."' ";
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                ...
                                                <div class="account-dropdown__item">
                                                    <a href="#">
                                                        <i class="zmdi zmdi-settings"></i>Confiración</a>
                                                </div>
                                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="login-content">
                                    ...
                                    <br>
                                    <form action="Actualizar_empleado_2.php"  method="post" class="formulario" id="formulario">
                                            ...
                                            <input type="submit" onclick="editarEmpleado()" name="enviar" id="enviar" value="Actualizar" class="au-btn au-btn--block au-btn--green m-b-20">
                                            </div>
                                            <!-- Grupo: id -->
                                            <div class="formulario__grupo" id="grupo__identificacion">
                                                <div class="formulario__grupo-input">
                                                    <input type="hidden" class="formulario__input" name="id_empleado" id="id_empleado" value="<?php echo $_GET['id_empleado']?>">
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                                <p class="formulario__input-error">La identificación solo puede contener numeros y un maximo de 10 dígitos</p>
                                            </div>
