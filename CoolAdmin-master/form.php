                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="container">
                                    ...
                                    <br> 
                                    <form action="funciones/registrar_producto.php"  method="post" class="formulario" id="formulario">
                                            <!-- Grupo: Tipo -->
                                            <div class="formulario__grupo" id="grupo__tipo">
                                                <label for="tipo" class="formulario__label">Tipo</label>
                                                <div class="formulario__grupo-input">
                                                    <input type="text" class="formulario__input" name="tipo" id="tipo" >
                                            ...
                                            <div class="formulario__grupo" id="grupo__precio">
                                                ...
                                                <div class="formulario__grupo-input">
                                                    <input type="text" class="formulario__input" name="precio" id="precio" >
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                            ...
                                            <div class="formulario__grupo" id="grupo__Volumen">
                                                ...
                                                <div class="formulario__grupo-input">
                                                    <input type="text" class="formulario__input" name="Volumen" id="Volumen" >
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                            ...
                                            <input type="submit" onclick="registrarProducto()" value="Registrar" class="au-btn au-btn--block au-btn--green m-b-20">
