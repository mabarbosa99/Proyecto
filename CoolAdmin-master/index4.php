    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
                        ...
                        <div class="header-wrap">
                            ...
                            <div class="header-button">
                                <div class="noti-wrap">
                                    ...
                                    $sentencia = "SELECT MAX(Id_Pedido) AS id FROM pedido";
                                    $noti = mysqli_query($conexion,$sentencia);
                                        ...
                                        <div class="notifi-dropdown js-dropdown">
                                            ...
                                            <div class="notifi__item">
                                                ...
                                                while($no = mysqli_fetch_array($noti)){
                                                    ?>
                                                <div class="content">
                                                    <p><?php echo 'Se registro un nuevo pedido <br />'; echo $no['id'];?></p>
            ...
            <div class="main-content">
                <div id="tabla" class="display"></div>
            </div>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                ...
                                <input type="text" name="" id="Id_cliente" class="form-control input-sm" disabled -/>
                                <label>Nombre</label>
                                <input type="text" name="" id="Nombre" class="form-control input-sm" disabled -/>
                                <label>Barrio</label>
                                <input type="text" name="" id="barrio" class="form-control input-sm" disabled -/>
                                <label>Telefono 1</label>
                                <input type="text" name="" id="telefono1" class="form-control input-sm" disabled -/>
                                <label>Telefono 2</label>
                                <input type="text" name="" id="telefono2" class="form-control input-sm" disabled -/>
                                <label>Dirección</label>
                                <input type="text" name="" id="Direccion" class="form-control input-sm" disabled -/>
                                <label>Pedido</label>
